...
proc create_root_design { parentCell } {
  ...
  # Create instance: ocl_block_0, and set properties
  set ocl_block_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ocl_block:1.0 ocl_block_0 ]
  set_property -dict [ list \
   CONFIG.HAS_KERNEL_CLOCK {false} \
 ] $ocl_block_0
  ...
  connect_bd_intf_net -intf_net ocl_block_0_M_AXI [get_bd_intf_pins ocl_block_0/M_AXI] [get_bd_intf_pins smartconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins ocl_block_0/S_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ocl_block_0/ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ocl_block_0/ARESET] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces ocl_block_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces ocl_block_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ocl_block_0/S_AXI/Reg0] -force
  ...
  set_property PFM.AXI_PORT {M01_AXI {memport "M_AXI_GP" sptag "" memory ""} M02_AXI {memport "M_AXI_GP" sptag "" memory ""} M03_AXI {memport "M_AXI_GP" sptag "" memory ""} M04_AXI {memport "M_AXI_GP" sptag "" memory ""} M05_AXI {memport "M_AXI_GP" sptag "" memory ""} M06_AXI {memport "M_AXI_GP" sptag "" memory ""} M07_AXI {memport "M_AXI_GP" sptag "" memory ""}} [get_bd_cells /smartconnect_0]
  set_property PFM.AXI_PORT {S01_AXI {memport "S_AXI_HPC" sptag "" memory ""} S02_AXI {memport "S_AXI_HPC" sptag "" memory ""} S03_AXI {memport "S_AXI_HPC" sptag "" memory ""}} [get_bd_cells /smartconnect_1]
